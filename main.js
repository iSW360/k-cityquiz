...
const locations = [
    ...
    { name: "인천", lat: 37.4563, lng: 126.7052, zoom: 9, geoName: "인천광역시", hint: "인천국제공항과 차이나타운이 있는 관문 도시" },
    ...
    { name: "안양시", lat: 37.3943, lng: 126.9568, zoom: 11, geoName: "안양시", hint: "안양예술공원과 평촌신도시가 있는 도시" },
    ...
    { name: "광명시", lat: 37.4786, lng: 126.8650, zoom: 11, geoName: "광명시", hint: "버려진 폐광을 테마파크로 만든 광명동굴이 유명함" },
    ...
    { name: "구리시", lat: 37.5939, lng: 127.1406, zoom: 11, geoName: "구리시", hint: "동구릉(조선 왕릉군)과 구리 한강시민공원이 유명함" },
    ...
    { name: "속초시", lat: 38.2070, lng: 128.5918, zoom: 10, geoName: "속초시", hint: "설악산 대청봉과 속초항 아바이마을, 닭강정이 유명함" },
    { name: "삼척시", lat: 37.4498, lng: 129.1653, zoom: 10, geoName: "삼척시", hint: "환선굴과 대이리 동굴지대, 장호항 어촌마을이 있음" },
    { name: "태백시", lat: 37.1656, lng: 128.9856, zoom: 10, geoName: "태백시", hint: "태백산 눈축제와 과거 석탄 산업의 중심지" },
    ...
    { name: "서산시", lat: 36.7800, lng: 126.4500, zoom: 10, geoName: "서산시", hint: "서산마애삼존불상과 간월도 어리굴젓이 유명함" },
    ...
    { name: "안동시", lat: 36.5600, lng: 128.7200, zoom: 10, geoName: "안동시", hint: "하회마을과 안동 찜닭, 간고등어, 안동소주가 유명함" },
    ...
    { name: "무안군", lat: 34.9928, lng: 126.4822, zoom: 10, geoName: "무안군", hint: "무안 갯벌과 회산 백련지, 세발낙지가 유명한 곳" },
    ...
    { name: "장흥군", lat: 34.6833, lng: 126.9042, zoom: 10, geoName: "장흥군", hint: "정남진 토요시장과 장흥 삼합(표고, 한우, 키조개)이 유명" },
    { name: "진도군", lat: 34.4869, lng: 126.2635, zoom: 10, geoName: "진도군", hint: "진돗개와 세방낙조, 신비의 바닷길 축제가 열림" },
    ...
    { name: "화순군", lat: 35.0614, lng: 126.9858, zoom: 10, geoName: "화순군", hint: "화순 고인돌 유적과 화순 적벽의 비경이 아름다운 곳" },
