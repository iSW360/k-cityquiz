...
const locations = [
    ...
    { name: "강서구", lat: 37.5509, lng: 126.8495, zoom: 10, geoName: "강서구" },
    ...
    { name: "서초구", lat: 37.4837, lng: 127.0324, zoom: 10, geoName: "서초구" },
    { name: "강남구", lat: 37.4959, lng: 127.0664, zoom: 10, geoName: "강남구" },
    { name: "송파구", lat: 37.5145, lng: 127.1061, zoom: 10, geoName: "송파구" },
...
const PROVINCE_VIEW_ZOOM = 10; // 서울 집중 줌
